...
def main():
    ...
    output_ids_bs = generate(params, tokenizer, sentences[1], max_length, max_new_tokens, beam_nums=5)
    ...
    inputs_pt_bs = tokenizer(sentences[1], padding='max_length', max_length=max_length, return_tensors='pt')
    with torch.no_grad():
    ...
    # JAX output (Beam Search): ['The Lord of the Rings is a series of high fantasy novels written by English author and scholar J. R. R. Tolkien. The story began as a sequel to Tolkien']
    # PyTorch output (Beam Search): ['The Lord of the Rings is a series of high fantasy novels written by English author and scholar J. R. R. Tolkien. The story began as a sequel to Tolkien']
