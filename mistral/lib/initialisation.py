...
# Taken from https://github.com/ayaka14732/llama-2-jax/blob/main/lib/proc_init_utils/initialisation.py
# to allow more devices with accelerator_type(e.g. v4-32)
...
def initialise_tpu(accelerator_type: str, n_devices: int | None=None, rank: int=0) -> None:
    ...
    elif accelerator_type == ('v4-16', 'v4-32'):
